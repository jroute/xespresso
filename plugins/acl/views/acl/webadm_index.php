...
<ul class="acl">
  <li><?php print $html->image('/acl/img/tango/32x32/apps/system-users.png') ?><?php print $html->link('Manage Aros', '/webadm/acl/aros') ?></li>
  <li><?php print $html->image('/acl/img/tango/32x32/apps/preferences-system-windows.png') ?><?php print $html->link('Manage Acos', '/webadm/acl/acos') ?></li>
  <li><?php print $html->image('/acl/img/tango/32x32/emblems/emblem-readonly.png') ?><?php print $html->link('Manage Permissions', '/webadm/acl/permissions') ?></li>
</ul>
<br />
