...
class ExcelHelper extends Helper {
  ...
  var $style     =  null;
	 ...
	 *@access public
	 */
	function createConfig($path = null, $filename = "auto") {
		$file  = $this->_getFilename($path, $filename);
	 ...
	 *@access private
	 */	
	function _getFilename($path, $filename) {
		if($filename == 'auto') {
			$filename  = strtolower(date("jYgis_") . ".xls");
