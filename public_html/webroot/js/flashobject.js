...
*/
        ...
        flashHTML += '<object type="application/x-shockwave-flash" width="'+ this.getAttribute('width') +'" height="'+ this.getAttribute('height') +'" id="'+ this.getAttribute('id') +'" data="' + this.getAttribute('swf') +'" >';
